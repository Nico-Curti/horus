...
class MachineSettingsDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        hbox.Add(self.machineShapeCombo, 0, wx.ALIGN_CENTER_VERTICAL)#| wx.ALIGN_RIGHT)
        ...
        self.diam_hbox.Add(self.diameterLabel, 0, wx.ALIGN_CENTER_VERTICAL, 10)#| wx.ALIGN_RIGHT, 10)
        self.diam_hbox.AddStretchSpacer()
        self.diam_hbox.Add(self.diameterField, 0, wx.ALIGN_CENTER_VERTICAL)#| wx.ALIGN_RIGHT)
        ...
        self.width_hbox.Add(self.widthField, 0, wx.ALIGN_CENTER_VERTICAL)#| wx.ALIGN_RIGHT)
        vbox.Add(self.width_hbox, 0, wx.ALL | wx.EXPAND, 10)
        # Height
        hbox = wx.BoxSizer(wx.HORIZONTAL)
        hbox.Add(self.heightLabel, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 10)
        hbox.AddStretchSpacer()
        hbox.Add(self.heightField, 0, wx.ALIGN_CENTER_VERTICAL)#| wx.ALIGN_RIGHT)
        ...
        self.depth_hbox.Add(self.depthField, 0, wx.ALIGN_CENTER_VERTICAL)#| wx.ALIGN_RIGHT)
        ...
        hbox.AddStretchSpacer()
        hbox.Add(self.machineModelField, 0, wx.ALIGN_CENTER_VERTICAL)#| wx.ALIGN_RIGHT)
        vbox.Add(hbox, 0, wx.ALL | wx.EXPAND, 10)
        vbox.Add(wx.StaticLine(self), 0, wx.EXPAND | wx.ALL, 5)
